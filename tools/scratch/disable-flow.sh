...
$REDIS_CMD hget $FLOW_ID $INSTANCE_ID/router/config
$REDIS_CMD hset $FLOW_ID $INSTANCE_ID/router/config-bak $ENGINE_INPUT_DATA
$REDIS_CMD hset $FLOW_ID $INSTANCE_ID/router/config "{}"
