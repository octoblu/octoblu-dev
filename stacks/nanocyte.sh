...
tmux send-keys -t $SESSION:1.0 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-engine-http' C-m
tmux send-keys -t $SESSION:1.1 'cd ~/Projects/Octoblu/nanocyte-engine-worker' C-m
tmux send-keys -t $SESSION:1.1 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-engine-worker' C-m

tmux send-keys -t $SESSION:2.0 'cd ~/Projects/Octoblu/nanocyte-interval-redis' C-m
tmux send-keys -t $SESSION:2.0 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-interval-redis' C-m
tmux send-keys -t $SESSION:2.1 'cd ~/Projects/Octoblu/nanocyte-interval-service' C-m
tmux send-keys -t $SESSION:2.1 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-interval-service' C-m

tmux send-keys -t $SESSION:3.0 'cd ~/Projects/Octoblu/nanocyte-flow-deploy-service' C-m
tmux send-keys -t $SESSION:3.0 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-flow-deploy-service' C-m

tmux send-keys -t $SESSION:4.0 'cd ~/Projects/Octoblu/nanocyte-node-registry' C-m
tmux send-keys -t $SESSION:4.0 'eval $SERVICES/$DOCKER_OR_LOCAL nanocyte-node-registry' C-m

tmux send-keys -t $SESSION:5.0 'cd ~/Projects/Octoblu/credentials-worker' C-m
tmux send-keys -t $SESSION:5.0 'eval $SERVICES/$DOCKER_OR_LOCAL credentials-worker' C-m
tmux send-keys -t $SESSION:5.1 'cd ~/Projects/Octoblu/credentials-service' C-m
tmux send-keys -t $SESSION:5.1 'eval $SERVICES/$DOCKER_OR_LOCAL credentials-service' C-m
