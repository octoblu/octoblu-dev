...
tmux send-keys -t $SESSION:1.0 'eval $SERVICES/$DOCKER_OR_LOCAL cwc-authenticator-proxy-service' C-m

# tmux send-keys -t $SESSION:2.0 'cd ~/Projects/Octoblu/meshblu-authenticator-cwc-staging' C-m
# tmux send-keys -t $SESSION:2.0 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-authenticator-cwc-staging' C-m
#
# tmux send-keys -t $SESSION:3.0 'cd ~/Projects/Octoblu/meshblu-authenticator-cwc' C-m
# tmux send-keys -t $SESSION:3.0 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-authenticator-cwc' C-m
