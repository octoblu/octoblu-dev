...
tmux send-keys -t $SESSION:1.0 'eval $SERVICES/$DOCKER_OR_LOCAL flow-canary' C-m

tmux send-keys -t $SESSION:2.0 'cd ~/Projects/Octoblu/triggers-service' C-m
tmux send-keys -t $SESSION:2.0 'eval $SERVICES/$DOCKER_OR_LOCAL triggers-service' C-m
