...
tmux send-keys -t $SESSION:2.0 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-server-http' C-m
tmux send-keys -t $SESSION:2.1 'cd ~/Projects/Octoblu/meshblu-server-socket.io-v1' C-m
tmux send-keys -t $SESSION:2.1 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-server-socket.io-v1' C-m
tmux send-keys -t $SESSION:2.2 'cd ~/Projects/Octoblu/meshblu-server-websocket' C-m
tmux send-keys -t $SESSION:2.2 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-server-websocket' C-m

tmux send-keys -t $SESSION:3.0 'cd ~/Projects/Octoblu/meshblu-core-dispatcher' C-m
tmux send-keys -t $SESSION:3.0 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-core-dispatcher whiskey' C-m
tmux send-keys -t $SESSION:3.1 'cd ~/Projects/Octoblu/meshblu-core-dispatcher' C-m
tmux send-keys -t $SESSION:3.1 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-core-dispatcher tango' C-m
tmux send-keys -t $SESSION:3.2 'cd ~/Projects/Octoblu/meshblu-core-dispatcher' C-m
tmux send-keys -t $SESSION:3.2 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-core-dispatcher foxtrot' C-m

tmux send-keys -t $SESSION:4.0 'cd ~/Projects/Octoblu/meshblu-core-firehose-socket.io' C-m
tmux send-keys -t $SESSION:4.0 'eval $SERVICES/$DOCKER_OR_LOCAL meshblu-core-firehose-socket.io' C-m
